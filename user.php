    ...
    <div class="panel-heading">
        <form class="form-inline">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <a class="btn btn-primary" href="?m=tambah_user"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
            </div>
            <div class="form-group">
        ...
        <table class="table table-bordered table-hover table-striped m-0">
            ...
            foreach ($rows as $row) : ?>
                <tr>
                    ...
                    <td><?= $row->level ?></td>
                    <td class="nw">
                         <a class="btn btn-xs btn-warning" href="?m=edit_user&ID=<?= $row->kode_user ?>"><span class="glyphicon glyphicon-edit"></span></a>
